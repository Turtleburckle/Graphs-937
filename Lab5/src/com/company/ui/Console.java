...
public class Console {
            ...
            try {
                ...
                switch (option) {
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        this.highestCostPathForDAG();
                        break;
                    case 9:
                        this.colorUndirectedGraph();
                    case 0:
                        System.exit(0);
                    default:
    ...
    private void lowestPath(){
        try{
            System.out.println("-> Source");
            int vertex1 = this.validator.validateVertexInput(this.readObject.nextLine());
            System.out.println("-> Target");
            int vertex2 = this.validator.validateVertexInput(this.readObject.nextLine());
            System.out.println(this.controller.lowestCost(vertex1,vertex2));
        }catch(ValidatorException exception){ System.out.println(exception.getMessage());}
    }

    private void topologicalSorting(){
        try{
            System.out.println(this.controller.topologicalSorting());
            this.sevenRun = true;
        }catch(ValidatorException exception){ System.out.println(exception.getMessage());}
    }

    private void highestCostPathForDAG(){
        try{
            if(!this.sevenRun){
                System.out.println("First you must run the 7th command in order to check if the Graph is Acyclic!");
            }else{
                System.out.println("-> Source : ");
                int vertex1 = this.validator.validateVertexInput(this.readObject.nextLine());
                System.out.println("-> Target : ");
                int vertex2 = this.validator.validateVertexInput(this.readObject.nextLine());
                System.out.println(this.controller.findHighestCostPathDAG(vertex1,vertex2));
            }
        }catch(ValidatorException exception){ System.out.println(exception.getMessage());}
    }

    private void colorUndirectedGraph(){
        try{
            System.out.println(this.controller.getColoredGraph());
        }catch(ValidatorException exception){ System.out.println(exception.getMessage());}
    }
    ...
    private void printable(){
        ...
        System.out.println("5. Backward BFS (Lab2)");
        System.out.println("6. Lowest path between two vertices. (Lab3)");
        System.out.println("7. Topological Sorting. (Lab4)");
        System.out.println("8. Highest Cost Path. (Lab4)");
        System.out.println("9. Color Undirected Graph. (Lab5)");
