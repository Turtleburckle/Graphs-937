...
public class Controller {
    ...
    public String topologicalSorting(){return this.repository.getTopologicalSorting();}

    public String findHighestCostPathDAG(int source, int target){return this.repository.getHighestCostPathDAG(source,target);}

    public String getColoredGraph(){return this.repository.getColoredGraph();}
}
