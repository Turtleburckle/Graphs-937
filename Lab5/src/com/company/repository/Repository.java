...
public class Repository {
    ...
    public String lowestPath(int source, int target){
        this.validator.existVertexGood(source, this.graph.getVertices());
        this.validator.existVertexGood(target, this.graph.getVertices());
        return this.graph.getLowestPath(source, target);
    }

    public String getTopologicalSorting(){
        return this.graph.TopologicalSorting();
    }

    public String getHighestCostPathDAG(int source, int target) throws ValidatorException{
        this.validator.existVertexGood(source, this.graph.getVertices());
        this.validator.existVertexGood(target,this.graph.getVertices());
        return this.graph.highestCostPathDAG(source,target);
    }

    public String getColoredGraph(){return this.graph.colorGraphMinimum();}
    ...
    public void addColor(String name, String initial){
        this.graph.addColor(name,initial);
    }
