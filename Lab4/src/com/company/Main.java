...
public class Main {
    ...
    public static String getFilename(){
        ...
        System.out.println("8. ExampleBFS2.");
        System.out.println("9. Lowest Path.");
        System.out.println("10. Lowest Path with Negative Cycle.");
        ...
        try{
            ...
            switch (option){
                ...
                case 9:
                    return "data/lowestPath.txt";
                case 10:
                    return "data/lowestPathNegativeCycle.txt";
                default:
